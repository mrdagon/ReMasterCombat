...
namespace SDX_RMC
{
	...
	namespace MSound
	{
		...
		static void Load()
		{
			効果音[SEType::打撃].Load("sound/bosu20.wav");
			効果音[SEType::爆発].Load("sound/bosu23.wav");
			効果音[SEType::支払い].Load("sound/coin06.wav");
			効果音[SEType::獲得].Load("sound/coin07.wav");
			効果音[SEType::決定].Load("sound/cursor01.wav");
			効果音[SEType::キャンセル].Load("sound/cursor04.wav");
			効果音[SEType::決定2].Load("sound/cursor026.wav");
			効果音[SEType::突風].Load("sound/eco00.wav");
			効果音[SEType::金属音].Load("sound/eco03.wav");
			効果音[SEType::炎上].Load("sound/fire02.wav");
			効果音[SEType::大爆発].Load("sound/gun16.wav");
			効果音[SEType::打撃2].Load("sound/hit_p09.wav");
			効果音[SEType::強化].Load("sound/power03.wav");
			効果音[SEType::回復].Load("sound/power20.wav");
			効果音[SEType::進化].Load("sound/power32.wav");
			効果音[SEType::決定3].Load("sound/push48.wav");
			効果音[SEType::ピョロ].Load("sound/pyoro65.wav");
			効果音[SEType::大振り].Load("sound/swing41.wav");
			効果音[SEType::猫声].Load("sound/voice006.wav");
			効果音[SEType::雨].Load("sound/water02.wav");
		}
	}
